...
<body>
    ...
    <div class="main-content">
        ...
        <button class="btn-primary" data-toggle="modal" data-target="#exampleModal"> + Nuovo Obiettivo</button>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nuovo Obiettivo Importantissimo</h5>
